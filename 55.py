...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EoYJIKOcce9hYHrpHpC8.26EM2o+nBqPn+GPYKpfBAa.6ou1RXKgreDnIJWaH0d6hBFYMTqL9wl/FU3CWH4YAGU=")
cl.loginResult()

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token="EoPNgY0LfVBFwihDLlf1.C+TdLVVLQdydLYvK6wIuiq.AQnUy081wY1ZRrM/rkiYjwxzi3/aYNKJjc51qI5nTto=")
ki.loginResult()

ki2 = LINETCR.LINE()
#ki2.login(qr=True)
ki2.login(token="EoUMDH9hv6utHNqpGP48.2k5RU+pBtUFei2dSstwBEa.NFP06eoJ6Pejr2g/t1RpgTEf429vIyhIYr641GzVc3g=")
ki2.loginResult()

ki3 = LINETCR.LINE()
#ki3.login(qr=True)
ki3.login(token="EoMXyfUiEFRI5W7BoEse.PxAXNlSCMIA2nMcrtUErVG.Wiy6mAtPra7MSXxxXa9V5TAUyauloBcU7JP8yr5rm4k=")
ki3.loginResult()

ki4 = LINETCR.LINE()
#ki4.login(qr=True)
ki4.login(token="EovL0LblM3nzu3vzLb2c.3nkuNiO4VRwNsW011Xda7a.9+OdrJ/s8CMCXhByjzDoEmyWxljrVkKmPNOQ1Gs9H6g=")
ki4.loginResult()
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,"udba7a6d8efcd6d0a4dfe0a7290f15b68"]
bot1 = cl.getProfile().mid
admsa = "udba7a6d8efcd6d0a4dfe0a7290f15b68"
admin = "udba7a6d8efcd6d0a4dfe0a7290f15b68"
